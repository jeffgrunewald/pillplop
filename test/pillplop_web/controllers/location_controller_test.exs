defmodule PillplopWeb.LocationControllerTest do
  use PillplopWeb.ConnCase

  alias Pillplop.Sales

  @create_attrs %{latitude: "some latitude", longitude: "some longitude", pharmacy_id: 42}
  ...
  def fixture(:location) do
    {:ok, location} = Sales.create_location(@create_attrs)
    location
  end
